...
@WebServlet(name = "decrease-quantity-product", value = "/decrease-quantity-product")
public class DecreaseQuantityProductCart extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (cart != null) {
            ...
            cart.decreaseQuantity(Integer.parseInt(productId), Integer.parseInt(quantity));
            session.setAttribute("cartMap", cart);
            session.setAttribute(("totalCartPrice"), cart.getTotalCartPrice());

            String jsonResponse = "{\"status\": \"success\", \"message\": \"Decrease quantity product successfully\"}";
